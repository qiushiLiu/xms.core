...
namespace XMS.Core
{
	...
	{
		/// <summary>
		/// 初始化 <see cref="ArgumentNullOrWhiteSpaceException"/> 类的一个新实例。
		/// </summary>
		/// <remarks>
		/// 此构造函数将新实例的 Message 属性初始化为系统提供的消息，该消息对错误进行描述，例如“参数不能为null、空或空白字符串”。
		/// </remarks>
		public ArgumentNullOrWhiteSpaceException()
			: base("参数不能为null、空或空白字符串。")
		{
			this._message = "参数不能为null、空或空白字符串。";
		}

		/// <summary>
		/// 使用导致此异常的参数的名称初始化 <see cref="ArgumentNullOrWhiteSpaceException"/> 类的新实例。
		/// </summary>
		...
		public ArgumentNullOrWhiteSpaceException(string paramName)
			: base("参数不能为null、空或空白字符串。",paramName)
		{
			this._message = "参数不能为null、空或空白字符串。";
		}
		...
		/// <summary>
		/// 使用指定的错误消息和引发此异常的异常初始化 <see cref="ArgumentNullOrWhiteSpaceException"/> 类的新实例。
		/// </summary>
		...
		/// <summary>
		/// 使用指定的错误消息和导致此异常的参数的名称来初始化 <see cref="ArgumentNullOrWhiteSpaceException"/> 类的实例。
		/// </summary>
		/// <param name="paramName">导致异常的参数的名称。</param>
		...
		/// <summary>
		/// 使用指定的错误消息、导致此异常的参数的名称和原始内部异常来初始化 <see cref="ArgumentNullOrWhiteSpaceException"/> 类的实例。
		/// </summary>
		/// <param name="paramName">导致异常的参数的名称。</param>
		/// <param name="message">描述错误的消息。</param>
		...
		/// 此构造函数用 paramName 参数初始化新实例的 ParamName 属性。 paramName 的内容被设计为人可理解的形式。
		/// </remarks>
		public ArgumentNullOrWhiteSpaceException(string paramName, string message, Exception innerException)
