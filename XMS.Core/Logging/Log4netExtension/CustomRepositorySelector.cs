...
{
	// 自定义 RepositorySelector 实现，在 log4net.Core.DefaultRepositorySelector 的基础上稍作改进
	// 定死本来需要配置在程序集上面的属性:
	//		 [assembly: log4net.Config.XmlConfigurator(ConfigFileExtension = "config", Watch = true)]
	//	统一为：
	//		assemblyName.dll.log.config
	/// <summary>
	...
	internal class CustomRepositorySelector : IRepositorySelector
	{
		...
		public CustomRepositorySelector(Type defaultRepositoryType)
		{
		...
		/// log message.
		/// </remarks>
		private readonly static Type declaringType = typeof(CustomRepositorySelector);
