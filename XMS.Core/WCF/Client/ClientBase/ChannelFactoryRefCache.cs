...
namespace XMS.Core.WCF.Client
{
	...
	{
		private static EndpointTraitComparer DefaultEndpointTraitComparer;

		static ChannelFactoryRefCache()
		{
			ChannelFactoryRefCache<TChannel>.DefaultEndpointTraitComparer = new EndpointTraitComparer();
		}

		public ChannelFactoryRefCache(int watermark)
			: base((watermark * 4) / 5, watermark, ChannelFactoryRefCache<TChannel>.DefaultEndpointTraitComparer)
		{
		}
