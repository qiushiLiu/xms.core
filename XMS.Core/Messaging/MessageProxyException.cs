...
namespace XMS.Core.Messaging
{
	...
	public class MessageProxyException : Exception
	{
		/// <summary>
		...
		/// </remarks>
		public MessageProxyException(string message)
			: base(String.IsNullOrEmpty(message) ? "消息总线代理服务器中发生错误。" : message)
		{
		}
		...
		public MessageProxyException(string message, Exception innerException)
			: base(String.IsNullOrEmpty(message) ? "消息总线代理服务器中发生错误。" : message, innerException)
		{
		}
		...
		protected MessageProxyException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
